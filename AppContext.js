...
export const AppProvider = ({ children }) => {
  ...
  const login = async (userData) => {
    try {
      ...
      console.log(
        `Login attempt for user: ${userData.name}, ID: ${userData.id}`
      );
      ...
      setError(
        "Failed to save login information. Your login may not persist after closing the app."
      );
    }
  };
  ...
  const logout = async () => {
    try {
      ...
      // Set an error that can be displayed if needed
      setError(
        "Failed to completely clear login data. Please restart the app."
      );
    }
  };
      ...
      if (user && user.mongodb_data) {
        const updatedUser = {
          ...
          mongodb_data: {
            ...user.mongodb_data,
            favorite_players: [
              ...(user.mongodb_data.favorite_players || []),
              playerData,
            ],
          },
        };
  ...
  const removePlayerFromFavorites = async (playerId) => {
    ...
    try {
      ...
      setFavoritePlayers((prev) =>
        prev.filter((player) => player.player_id !== playerId)
      );
      ...
      if (user && user.mongodb_data) {
        const updatedUser = {
          ...
          mongodb_data: {
            ...user.mongodb_data,
            favorite_teams: [
              ...(user.mongodb_data.favorite_teams || []),
              teamData,
            ],
          },
        };
  ...
  const translations = {
    en: {
      ...
      databaseError:
        "Cannot connect to the database. Your favorite players and teams might not be available.",
      ...
      country: "Country",
      noDescriptionInLanguage:
        "No description available in your selected language. Here is the information in English:",
      ...
      events: "Events",
      recentEvents: "Recent Envents",
      noEventsAvailable: "No events available for this season.",
      homeTeam: "Home",
      awayTeam: "Away",
      result: "Result",
      date: "Date",
      ...
      lineup: "Lineup",
      lineups: "Lineups",
      noLineupAvailable: "No lineup available for this match.",
      starters: "Starting XI",
      substitutes: "Substitutes",
      formation: "Formation",
      homeTeamLineup: "Home Team Lineup",
      awayTeamLineup: "Away Team Lineup",
      number: "Number",
      player: "Player",
      position: "Position",
      ...
      noNextMatches: "No upcoming matches scheduled",
      wins: "Wins",
      draws: "Draws",
      losses: "Losses",
      goalsFor: "Goals For",
    ...
    es: {
      ...
      databaseError:
        "No se puede conectar a la base de datos. Es posible que tus jugadores y equipos favoritos no estén disponibles.",
      ...
      country: "País",
      noDescriptionInLanguage:
        "No hay información disponible en el idioma seleccionado. Aquí está la información en inglés:",
      ...
      noEventsAvailable: "No hay eventos disponibles para esta temporada.",
      homeTeam: "Local",
      awayTeam: "Visitante",
      result: "Resultado",
      date: "Fecha",
      ...
      noLineupAvailable: "No hay alineación disponible para este partido.",
      starters: "Titulares",
      substitutes: "Suplentes",
      formation: "Formación",
      homeTeamLineup: "Alineación Equipo Local",
      awayTeamLineup: "Alineación Equipo Visitante",
      number: "Número",
      player: "Jugador",
      position: "Posición",
      ...
      noNextMatches: "No hay próximos partidos programados",
      wins: "Victorias",
      draws: "Empates",
      losses: "Derrotas",
